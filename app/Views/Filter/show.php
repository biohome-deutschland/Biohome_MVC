            ...
            <div class="product-layout">
                <div class="product-media">
                    <?php if (!empty($filter['image_url'])): ?>
                        <img src="/<?php echo ltrim(htmlspecialchars($filter['image_url']), '/'); ?>" alt="<?php echo htmlspecialchars($filter['title']); ?>">
                    <?php else: ?>
                ...
                <div class="product-details">
                    ...
                    <h1><?php echo htmlspecialchars($filter['title']); ?></h1>
                    <div class="rich-text">
                        <?php
                    ...
                    <?php if ($video_url !== ''): ?>
                        <div class="filter-video">
                            <h3>Video</h3>
                            <?php if ($embed_url !== ''): ?>
                                <iframe src="<?php echo htmlspecialchars($embed_url); ?>" allowfullscreen loading="lazy"></iframe>
                            <?php else: ?>
                                <a href="<?php echo htmlspecialchars($video_url); ?>" target="_blank" rel="noopener">Video ansehen</a>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                </div>
